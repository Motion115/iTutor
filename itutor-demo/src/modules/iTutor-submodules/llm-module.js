                ...
                <Content style={{ padding: "10px 10px 10px 10px" }}>
                    <ContentBlock
                        ...
                        description={<div>
                            ...
                            <li>we inform chatGPT to provide instructions for navigating through a given application</li>
                            <li>we provide chatGPT with the three types of UI context with specific markings (!, $, and ```)</li>
                            <li>we request chatGPT to respond in JSON including the original command, next-step instruction, UI element to operate on, and the explanation.</li>

                            <br />
                            <b>20 UI types:</b> bare, dialer, camera, chat, editor, form, gallery, list, login, maps, mediaplayer, menu, modal, news, other, profile, search, settings, terms, and tutorial.
                            <br />
                            <br />
                            <b>UI component types:</b> Button, Input, Icon, Checkbox, Selector, Switch, Container, Tag, Menu. Refer to our github repository for detailed labling instructions.
                            <br />
                            <br />
                            Copy the prompt on the right for chatGPT's user interface or use the API to get the response. Be sure to replace the contents inside the bracket.
                        </div>
                        }
                        media={
                            <Paragraph>
