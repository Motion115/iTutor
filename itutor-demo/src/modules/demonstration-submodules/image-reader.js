...
class ImageContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      picture_referer: props.picture_referer
    };
  }
    ...
    return (
      <div>
        <Card
          ...
          cover={<Image src={this.state.picture_referer} style={picStyle} />}
          actions={[
  ...
  render() {
    return (
      <div>
        ...
        <ImageContainer picture_referer={tiktok_01_pic}/>
        <Row>
          <Col span={8}>
        ...
        <Row>
          ...
          <Col offset={5}>
            <Button onClick={() => this.selectImagetiktok_02()}>
              tiktok_02
            </Button>
          </Col>
          <Col offset={6}>
            <Button onClick={() => this.selectImagetiktok_03()}>
              tiktok_03
            </Button>
          </Col>
        </Row>
