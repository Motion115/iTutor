            ...
            <div>
                <Content style={{ padding: "10px 10px 10px 10px" }}>
                    ...
                    <Paragraph style={{ fontSize: "16px" }}>
                        Try out the iTutor pipeline demonstration by following the processing steps below.
                    </Paragraph>
                    ...
                    <Row>
                        <p>在这里按照不同的步骤，显示不同的内容。应记录每一个步骤的选项，支持倒回去查看和更改尝试。
                    ...
                    <Row style={{
                        ...
                        alignItems: 'center',
                        textAlign: 'center'}}>
                        <Button type="primary" onClick={()=>this.prev()}><LeftCircleOutlined />Prev</Button> &nbsp;&nbsp;
                        <Button type="primary" onClick={()=>this.forward()}>Next<RightCircleOutlined /></Button>
                    </Row>
